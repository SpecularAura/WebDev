function Project(projLink, projImg, projTitle, date) {
...
function handleEmailContactSubmit(event) {
    ...
    let errMsg = "";
    if (name.length < 3) {
        errMsg = "Your name should be more 3 characters";
